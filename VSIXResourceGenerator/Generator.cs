...
namespace ResourceGeneratorVSIX
{
    [PackageRegistration(UseManagedResourcesOnly = true)]
    [InstalledProductRegistration("ResourceGenerator", "Generate Resources", "1.0")]
    [Guid("964A3BA6-AE19-4523-B9BC-C159B07905B7")]
    [ComVisible(true)]
    [ProvideObject(typeof(ResourceGenerator))]
    [CodeGeneratorRegistration(typeof(ResourceGenerator), "ResourceGenerator", "{FAE14EC1-301F-11D3-BF4B-00C04F79EFBC}", GeneratesDesignTimeSource = true)]
    public class ResourceGenerator : IVsSingleFileGenerator
    {
        ...
        {
            return $"\t\tpublic static {nameof(ModsCommon)}.{nameof(ModsCommon.ResourceManager)} {LocaleManager} {{get;}} = new {nameof(ModsCommon)}.{nameof(ModsCommon.ResourceManager)}(\"{className}\", typeof({className}).{nameof(Type.Assembly)});";
        }
