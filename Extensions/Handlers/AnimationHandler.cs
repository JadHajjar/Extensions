...
public class AnimationHandler : IDisposable
{
	...
	public static bool NoAnimations { get => CrossIO.CurrentPlatform != Platform.Windows ? !_noAnimations : _noAnimations; set => _noAnimations = value; }
	...
	private static readonly List<AnimationHandler> runningHandlers = [];
	...
	{
		return new AnimationHandler(animatedControl, animations, speed, options).StartAnimation(action);
	}
	...
	{
		return new AnimationHandler(animatedControl, new[] { animations }, speed, options).StartAnimation(action);
	}
	...
	{
		return new AnimationHandler(animatedControl, new[] { animatedControl }, speed, options).StartAnimation(action);
	}
	...
	{
		return new AnimationHandler(animatedControl, newPadding, speed, options).StartAnimation(action);
	}

	public static AnimationHandler Animate(Control animatedControl, Padding newPadding, double speed, Action action = null)
	{
		return new AnimationHandler(animatedControl, newPadding, speed, AnimationOption.None).StartAnimation(action);
	}
	...
	{
		return new AnimationHandler(animatedControl, newPadding, 1, options).StartAnimation(action);
	}

	public static AnimationHandler Animate(Control animatedControl, Padding newPadding, Action action = null)
	{
		return new AnimationHandler(animatedControl, newPadding, 1, AnimationOption.None).StartAnimation(action);
	}
	...
	{
		return new AnimationHandler(animatedControl, newBounds, speed, options).StartAnimation(action);
	}

	public static AnimationHandler Animate(Control animatedControl, Rectangle newBounds, double speed, Action action = null)
	{
		return new AnimationHandler(animatedControl, newBounds, speed, AnimationOption.None).StartAnimation(action);
	}
	...
	{
		return new AnimationHandler(animatedControl, newBounds, options).StartAnimation(action);
	}

	public static AnimationHandler Animate(Control animatedControl, Rectangle newBounds, Action action = null)
	{
		return new AnimationHandler(animatedControl, newBounds, AnimationOption.None).StartAnimation(action);
	}
	...
	private bool applyBounds(Rectangle bounds, Padding padding, int[] newValues)
	{
		return AnimatedControl?.TryInvoke(() =>
	{
