...
namespace Extensions
{
	...
	{
		private static readonly List<BackgroundAction> _runningLoads = new List<BackgroundAction>();
		...
		public void RunIn(int milliseconds)
		{
			...
			timer.Elapsed += (s, e) => { Run(); timer.Dispose(); };
			timer.Start();
		}
		...
		public override string ToString() => $"[{Form?.Text ?? "Other Actions"}] {Name}";
	}
}
